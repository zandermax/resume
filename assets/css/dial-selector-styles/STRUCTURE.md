...
- `label-active-color`, `label-active-background`, `label-active-text-shadow`
- `label-active-box-shadow`, `label-active-filter`
- `label-active-span-padding-block`, `label-active-span-padding-inline`
- `label-active-span-padding-block--tablet`, `label-active-span-padding-inline--tablet`
- `label-active-span-padding-block--phone`, `label-active-span-padding-inline--phone`
- `label-active-span-border-width`, `label-active-span-border-style`, `label-active-span-border-color`
- `label-active-span-box-shadow`, `label-active-span-font-weight`
- `label-active-span-transform`
...
- `gap` - Override grid gap between columns (use with caution)
...
- `--dial-selector-gap` - For custom grid gaps (e.g., Web2Gloss theme)
